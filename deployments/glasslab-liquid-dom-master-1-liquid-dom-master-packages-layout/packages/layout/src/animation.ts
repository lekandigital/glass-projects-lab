...
/** Imperative animation function shape used by renderer integrations. */
...
export class AnimationTimeline {
  ...
  private readonly defaultTransition: AnimationConfig
  private readonly timeScaleRef: AnimationTimeScaleRef | undefined
  ...
  constructor(
    ...
    requestFrame: () => void,
    defaultTransition: AnimationConfig = true,
    timeScaleRef?: AnimationTimeScaleRef,
  ) {
